  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Recruiting - Transforming the way you hire. Our application streamlines the hiring process, making it easier and more efficient than ever before."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1603834305747-b0fb6f8bbfd6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxyZWNydWl0aW5nfGVufDB8fHx8MTY5NjM5MDg0MHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Recruiting - Transforming the way you hire. Our application streamlines the hiring process, making it easier and more efficient than ever before.`}
            </Text>
            <Box
