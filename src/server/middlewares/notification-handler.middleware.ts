...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Job Application Submission.create': {
    roles: ['recruiter', 'hiring-manager', 'hr-specialist'],
    key: 'job_application',
    tenantPath: [],
    userPath: [],
  },
  'Interview Scheduled.create': {
    roles: ['job-seeker', 'hiring-manager', 'hr-specialist'],
    key: 'interview_schedule',
    tenantPath: [],
    userPath: [],
  },
  'New Job Posting.create': {
    roles: ['recruiter', 'job-seeker', 'hr-specialist'],
    key: 'job_posting',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['recruiter', 'job-seeker', 'hiring-manager', 'admin', 'hr-specialist'];
